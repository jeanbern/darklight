...
void archonIndex(alias Factory)(HttpServerRequest req, HttpServerResponse res)
{
	enum content = `
<StackPanel containerTag="body" extraAttr="data-spy='scroll' data-twttr-rendered='true'">
	<ArchonNav live="homenav"/>
	<StackPanel clss="jumbotron masthead">
		<StackPanel clss="container">
			...
			<pNode>
				<HRef clss="btn btn-primary btn-large" content="Learn About Home Energy Efficiency" link="#intro"/>
			</pNode>
	...
	<StackPanel clss="container">
		<Section id="intro" clss="marketing">
